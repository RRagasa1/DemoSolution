<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TrackCRUD - Copy.aspx.cs" Inherits="Admin_EntityMaintenance_TrackCRUD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="jumbotron">
      ...
      <%-- the following is the user control to handle messages
    ...
    <asp:ObjectDataSource ID="AlbumODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" 
    ...
    <asp:ObjectDataSource ID="GenreODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" 
